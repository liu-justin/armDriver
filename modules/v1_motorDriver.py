...
def getSteps(angles):
    ...
    for i in range(len(angles)-1):
        ...
        print(f"delayR: {stepTimeR} delayC: {stepTimeC}")
    ...
    plt.step(timeListC, stepListC, where="mid", label="angleC step")
    plt.step(timeListR, stepListR, where="mid", label="angleR step")
